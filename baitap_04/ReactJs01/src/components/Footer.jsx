    ...
    <footer className="bg-white pt-4 pb-2">
      <div className="w-full px-6">
        <div className="grid md:grid-cols-4 gap-6 mb-6">
          ...
          <div>
            ...
            <div className="space-y-1 text-gray-600 text-sm">
              <p>42/21/2 8 Stret, Linh Trung, Thu Duc</p>
              <p>Email: nsndman0404@gmail.com</p>
              <p>Phone: (+84) 0377179132</p>
            </div>
          </div>
        ...
        <div className="text-center text-gray-500 pt-4 border-t text-sm">
          <p>&copy; 2025 ChimSe. Gìn giữ hương vị quê hương, kết nối mọi miền.</p>
        </div>
      </div>
    </footer>
  );
